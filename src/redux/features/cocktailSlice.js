...
export const fetchSearchCocktail = createAsyncThunk("cocktails/fetchSingleCocktail",
  async({searchText})=>{
    return fetch(`https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i=${searchText}`)
